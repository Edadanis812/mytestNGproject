...
public class Day12_Assertions {
    ...
    /* ASSERTION IS LIKE IF-ELSE STATEMENT*/
     /*
     -What is soft assertion? :
         Verifying all test cases using soft assertion.
    ...
    public void softAssert(){
        //1.Create a SoftAssert object which is coming from TestNG
        SoftAssert softAssert=new SoftAssert();
        System.out.println("This is line 19");
        ...
        softAssert.assertEquals("5",5);//pass.This will NOT be on the console as FAILED.
